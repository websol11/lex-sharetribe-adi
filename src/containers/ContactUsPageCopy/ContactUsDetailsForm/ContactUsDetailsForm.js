...
import css from './ContactUsDetailsForm.module.css';

const SHOW_EMAIL_SENT_TIMEOUT = 2000;

class ContactUsDetailsFormComponent extends Component {
  constructor(props) {
    super(props);
...
ContactUsDetailsFormComponent.defaultProps = {
  rootClassName: null,
  className: null,
  formId: null,
  saveEmailError: null,
...
ContactUsDetailsFormComponent.propTypes = {
...
const ContactUsDetailsForm = compose(injectIntl)(ContactUsDetailsFormComponent);

ContactUsDetailsForm.displayName = 'ContactUsDetailsForm';
