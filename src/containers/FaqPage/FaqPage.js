    ...
    >
      <LayoutSingleColumn>
        ...
        <LayoutWrapperMain className={css.staticPageWrapper}>
          ...
          <span>A: Block Lunch is your go-to marketplace to buy items with 100+ cryptos.</span>
          ...
          <span>A: Sign up as a seller today to list your items on Block Lunch.</span>
          ...
          <span>A: We’re thrilled to be an approved vendor of the StarDust ecosystem. All Block Lunch payouts are in StarDust ($DUST), based on our marketplace’s portion of the token’s monthly minting schedule.</span>
