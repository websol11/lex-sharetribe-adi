...
const TermsOfService = props => {
  ...
  return (
    <div className={classes}>
      <p className={css.lastUpdated}>Last updated: April 13, 2022</p>
      ...
      <div className={css.descp}> 
        ...
        <p><b>Country</b> refers to: Indiana, United States</p>
        <p><b>Company</b> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Blockblr Inc., 1 Cupertino, CA 95014.</p>
        <p><b>Device</b> means any device that can access the Service such as a computer, a cellphone or a digital tablet.</p>
        <p><b>Feedback</b> means feedback, innovations or suggestions sent by You regarding the attributes, performance or features of our Service.</p>
        ...
        <p><b>Promotions</b> refer to contests, sweepstakes or other promotions offered through the Service.</p>
        ...
        <p><b>Website</b> refers to Block Lunch, accessible from <a href="https://blocklunch.com" target='_blank'>https://blocklunch.com</a></p>
      ...
      <ul>
        <li>By visiting this page on our website: <a href="https://www.blocklunch.com/contact" target='_blank'>https://www.blocklunch.com/contact</a></li>
      </ul>
    </div>
  );
};
