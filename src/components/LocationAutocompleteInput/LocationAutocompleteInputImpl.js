...
const LocationPredictionsList = props => {
  ...
  const item = (prediction, index) => {
    ...
    console.log("ON OJ",prediction, geocoder.getPredictionAddress(prediction));
...
class LocationAutocompleteInputImpl extends Component {
  ...
  predict(search) {
    ...
    console.log("here", currentValue(this.props));
