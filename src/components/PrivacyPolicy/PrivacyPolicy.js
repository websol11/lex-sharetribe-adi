...
const PrivacyPolicy = props => {
  ...
  return (
    <div className={classes}>
      ...
      <div className={css.descp}>
        <p><b>MailerLite</b></p>
        <p>Their Privacy Policy can be viewed at <a href="https://www.mailerlite.com/legal/privacy-policy" target="_blank">https://www.mailerlite.com/legal/privacy-policy</a></p>
      </div>
      ...
      <div className={css.descp}>
        <p><b>NOWPayments</b></p>
        <p>Their Privacy Policy can be viewed at <a href="https://nowpayments.io/doc/privacy_policy-v1_2_2.pdf" target="_blank">https://nowpayments.io/doc/privacy_policy-v1_2_2.pdf</a></p>
      </div>
      ...
      <div className={css.descp}>
        ...
        <p>Collected: Yes.</p>
        <p><b>Category B: Personal information categories listed in the California Customer Records statute (Cal. Civ. Code § 1798.80(e)).</b></p>
        <p>Examples: A name, signature, Social Security number, physical characteristics or description, address, telephone number, passport number, driver's license or state identification card number, insurance policy number, education, employment, employment history, bank account number, credit card number, debit card number, or any other financial information, medical information, or health insurance information. Some personal information included in this category may overlap with other categories.</p>
        <p>Collected: Yes.</p>
        <p><b>Category C: Protected classification characteristics under California or federal law.</b></p>
        ...
        <p>Collected: No.</p>
        <p><b>Category J: Non-public education information (per the Family Educational Rights and Privacy Act (20 U.S.C. Section 1232g, 34 C.F.R. Part 99)).</b></p>
      ...
      <ul>
        ...
        <li><b>The right to request.</b> Under CCPA, You have the right to request that We disclose information to You about Our collection, use, sale, disclosure for business purposes and share of personal information. Once We receive and confirm Your request, We will disclose to You: </li>
        <div className={css.descp}>
          <ul>
        ...
        <li><b>The right to say no to the sale of Personal Data (opt-out).</b> You have the right to direct Us to not sell Your personal information. To submit an opt-out request please contact Us.</li>
        <li><b>The right to delete Personal Data. </b> You have the right to request the deletion of Your Personal Data, subject to certain exceptions. Once We receive and confirm Your request, We will delete (and direct Our Service Providers to delete) Your personal information from our records, unless an exception applies. We may deny Your deletion request if retaining the information is necessary for Us or Our Service Providers to: </li>
        <div className={css.descp}>
          <ul>
